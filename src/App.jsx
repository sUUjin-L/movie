...
const DramaTravelGuide = () => {
  ...
  const mediaList = [
    ...
    { 
      id: 'single-inferno', 
      title: "솔로지옥 5", 
      image: "https://www.google.com/search?q=thffhwldhr+5&oq=thffhwldhr+5&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIGCAEQABgDMgYIAhAAGAMyBggDEAAYAzIGCAQQABgDMgYIBRAAGAMyBggGEAAYAzIGCAcQABgDMgYICBAAGAMyBggJEAAYA9IBCDE1MjNqMGo3qAIIsAIB&sourceid=chrome&ie=UTF-8", 
      type: "Netflix 예능", 
      functional: true,
